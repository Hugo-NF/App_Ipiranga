...
public:
    ...
    void setupUi(QMainWindow *UserApp)
    {
        ...
        gridLayout_7->addWidget(Order_by, 0, 6, 5, 1);
        ...
        gridLayout_7->addWidget(Friendship, 1, 4, 4, 1);
        ...
        line_state->setMaximumSize(QSize(55, 22));
        ...
        gridLayout->addWidget(Order_by_2, 0, 7, 4, 1);
        ...
        gridLayout->addWidget(Friendship_2, 0, 3, 4, 1);
    ...
    void retranslateUi(QMainWindow *UserApp)
    {
        ...
        label_category->setText(QApplication::translate("UserApp", "Category", Q_NULLPTR));
        Order_by->setTitle(QApplication::translate("UserApp", " Order by", Q_NULLPTR));
        command_rating->setText(QApplication::translate("UserApp", "Rating", Q_NULLPTR));
        command_quantity->setText(QApplication::translate("UserApp", "Quantity", Q_NULLPTR));
        command_price->setText(QApplication::translate("UserApp", "Price", Q_NULLPTR));
        command_city->setText(QApplication::translate("UserApp", "City", Q_NULLPTR));
        command_title->setText(QApplication::translate("UserApp", "Title", Q_NULLPTR));
        command_category->setText(QApplication::translate("UserApp", "Category", Q_NULLPTR));
        comboBox_category->clear();
        comboBox_category->insertItems(0, QStringList()
         << QString()
         << QApplication::translate("UserApp", "Animals", Q_NULLPTR)
         << QApplication::translate("UserApp", "Automobiles", Q_NULLPTR)
         << QApplication::translate("UserApp", "Books", Q_NULLPTR)
         << QApplication::translate("UserApp", "Clothes", Q_NULLPTR)
         << QApplication::translate("UserApp", "Computing", Q_NULLPTR)
         << QApplication::translate("UserApp", "Construction", Q_NULLPTR)
         << QApplication::translate("UserApp", "Drinks", Q_NULLPTR)
         << QApplication::translate("UserApp", "Electronics", Q_NULLPTR)
         << QApplication::translate("UserApp", "Food", Q_NULLPTR)
         << QApplication::translate("UserApp", "Furniture", Q_NULLPTR)
         << QApplication::translate("UserApp", "Games", Q_NULLPTR)
         << QApplication::translate("UserApp", "Home Appliances", Q_NULLPTR)
         << QApplication::translate("UserApp", "Kitchen", Q_NULLPTR)
         << QApplication::translate("UserApp", "Leisure", Q_NULLPTR)
         << QApplication::translate("UserApp", "Leisure Services", Q_NULLPTR)
         << QApplication::translate("UserApp", "Medicines", Q_NULLPTR)
         << QApplication::translate("UserApp", "Music", Q_NULLPTR)
         << QApplication::translate("UserApp", "Office", Q_NULLPTR)
         << QApplication::translate("UserApp", "Properties", Q_NULLPTR)
         << QApplication::translate("UserApp", "Shoes", Q_NULLPTR)
         << QApplication::translate("UserApp", "Sport", Q_NULLPTR)
         << QApplication::translate("UserApp", "Ticket", Q_NULLPTR)
         << QApplication::translate("UserApp", "Travel", Q_NULLPTR)
        );
        Friendship->setTitle(QApplication::translate("UserApp", "Friendship", Q_NULLPTR));
        radio_all->setText(QApplication::translate("UserApp", "All", Q_NULLPTR));
        radio_friends->setText(QApplication::translate("UserApp", "Friends", Q_NULLPTR));
        radio_friends_of->setText(QApplication::translate("UserApp", "Friends of \n"
"Friends", Q_NULLPTR));
        label_state->setText(QApplication::translate("UserApp", "State", Q_NULLPTR));
        Order_by_2->setTitle(QApplication::translate("UserApp", " Order by", Q_NULLPTR));
        command_rating_2->setText(QApplication::translate("UserApp", "Rating", Q_NULLPTR));
        command_name->setText(QApplication::translate("UserApp", "Name", Q_NULLPTR));
        command_city_2->setText(QApplication::translate("UserApp", "City", Q_NULLPTR));
        line_state_2->setInputMask(QApplication::translate("UserApp", "AA", Q_NULLPTR));
        line_state_2->setText(QString());
        Friendship_2->setTitle(QApplication::translate("UserApp", "Friendship", Q_NULLPTR));
        radio_all_2->setText(QApplication::translate("UserApp", "All", Q_NULLPTR));
        radio_friends_2->setText(QApplication::translate("UserApp", "Friends", Q_NULLPTR));
        radio_friends_of_2->setText(QApplication::translate("UserApp", "Friends of \n"
"Friends", Q_NULLPTR));
        label_state_2->setText(QApplication::translate("UserApp", "State", Q_NULLPTR));
        User_img->setText(QString());
        UserName->setText(QApplication::translate("UserApp", "User Name", Q_NULLPTR));
        Button_logout->setText(QApplication::translate("UserApp", "Logout", Q_NULLPTR));
        Button_historic->setText(QApplication::translate("UserApp", "Historic", Q_NULLPTR));
#ifndef QT_NO_WHATSTHIS
        Button_edit->setWhatsThis(QApplication::translate("UserApp", "<html><head/><body><p>this is nothing</p><p><br/></p></body></html>", Q_NULLPTR));
#endif // QT_NO_WHATSTHIS
        Button_edit->setText(QApplication::translate("UserApp", "Edit. Profile", Q_NULLPTR));
        Button_friends->setText(QApplication::translate("UserApp", "Friends", Q_NULLPTR));
        Button_advertise->setText(QApplication::translate("UserApp", "Advertise", Q_NULLPTR));
        Button_home->setText(QApplication::translate("UserApp", "Home", Q_NULLPTR));
    } // retranslateUi
