...
public:
    ...
    {
        HistoricPage->setWindowTitle(QApplication::translate("HistoricPage", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("HistoricPage", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; color:#087add;\">My Historic</span></p></body></html>", Q_NULLPTR));
        Button_all->setText(QApplication::translate("HistoricPage", "All", Q_NULLPTR));
        Button_sales->setText(QApplication::translate("HistoricPage", "Sales", Q_NULLPTR));
        Button_shopping->setText(QApplication::translate("HistoricPage", "Shopping", Q_NULLPTR));
    } // retranslateUi
