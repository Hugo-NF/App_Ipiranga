...
public:
    ...
    {
        LoginUser->setWindowTitle(QApplication::translate("LoginUser", "Login", Q_NULLPTR));
        Login->setTitle(QString());
        label_user->setText(QApplication::translate("LoginUser", "User Name", Q_NULLPTR));
        label_password->setText(QApplication::translate("LoginUser", "Password", Q_NULLPTR));
        linePass->setText(QApplication::translate("LoginUser", "12345678", Q_NULLPTR));
#ifndef QT_NO_ACCESSIBILITY
        lineName->setAccessibleName(QString());
#endif // QT_NO_ACCESSIBILITY
        lineName->setText(QApplication::translate("LoginUser", "Eumemo", Q_NULLPTR));
        pushLogin->setText(QApplication::translate("LoginUser", "Login", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        pushLogin->setShortcut(QApplication::translate("LoginUser", "Return", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        pushRegister->setText(QApplication::translate("LoginUser", "Register", Q_NULLPTR));
