...
public:
    ...
    {
        FriendsPage->setWindowTitle(QApplication::translate("FriendsPage", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("FriendsPage", "<html><head/><body><p><span style=\" font-weight:600; color:#087add;\">My Friends</span></p></body></html>", Q_NULLPTR));
