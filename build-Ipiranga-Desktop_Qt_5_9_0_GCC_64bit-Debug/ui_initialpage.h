...
public:
    ...
    {
        InitialPage->setWindowTitle(QApplication::translate("InitialPage", "Form", Q_NULLPTR));
        MyAccount->setTitle(QApplication::translate("InitialPage", "My Account", Q_NULLPTR));
        label_rating->setText(QApplication::translate("InitialPage", "<html><head/><body><p><span style=\" color:#3390e7;\">Rating:</span></p></body></html>", Q_NULLPTR));
        label_balance->setText(QApplication::translate("InitialPage", "<html><head/><body><p><span style=\" color:#3390e7;\">Balance (R$):</span></p></body></html>", Q_NULLPTR));
        label_email->setText(QApplication::translate("InitialPage", "<html><head/><body><p><span style=\" color:#3390e7;\">E-mail:</span></p></body></html>", Q_NULLPTR));
        label_cpf->setText(QApplication::translate("InitialPage", "<html><head/><body><p><span style=\" color:#3390e7;\">CPF:</span></p></body></html>", Q_NULLPTR));
        CPF->setText(QApplication::translate("InitialPage", "<html><head/><body><p><span style=\" font-style:italic;\">12345678911</span></p></body></html>", Q_NULLPTR));
        Email->setText(QApplication::translate("InitialPage", "<html><head/><body><p><span style=\" font-style:italic;\">joseluizgnogueira@@@@@.com</span></p></body></html>", Q_NULLPTR));
        Balance->setText(QApplication::translate("InitialPage", "<html><head/><body><p>123456789.00</p></body></html>", Q_NULLPTR));
        Rating->setText(QApplication::translate("InitialPage", "4.5", Q_NULLPTR));
        label->setText(QApplication::translate("InitialPage", "<html><head/><body><p>/<span style=\" font-size:8pt;\">5.0</span></p></body></html>", Q_NULLPTR));
        Name->setText(QApplication::translate("InitialPage", "Jos\303\251 Luiz Gomes Nogueira", Q_NULLPTR));
        Ipiranga->setText(QApplication::translate("InitialPage", "<html><head/><body><p align=\"center\"><span style=\" font-size:72pt; font-weight:600; font-style:italic; color:#3465a4;\">I</span><span style=\" font-size:72pt; font-weight:600; font-style:italic; color:#3f66ca;\">piranga!</span></p><p align=\"center\"><span style=\" font-weight:600; color:#729fcf;\">Welcome</span><span style=\" font-weight:600;\"> to a new world,</span></p><p align=\"center\"><span style=\" font-weight:600;\">where you can find all, that exist in the universe!</span></p><p align=\"center\"><br/></p><p align=\"center\"><br/></p><p align=\"center\"><br/></p></body></html>", Q_NULLPTR));
    } // retranslateUi
