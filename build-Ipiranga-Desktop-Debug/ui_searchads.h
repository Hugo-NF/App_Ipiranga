...
public:
    ...
    void setupUi(QWidget *SearchAds)
    {
        ...
        gridLayout->addWidget(line_quantity, 6, 1, 1, 1);
        ...
        gridLayout->addWidget(line_date, 0, 1, 1, 1);
    ...
    {
        SearchAds->setWindowTitle(QApplication::translate("SearchAds", "Form", 0));
        Box_Ads->setTitle(QApplication::translate("SearchAds", "Title of Ads", 0));
        label_price->setText(QApplication::translate("SearchAds", "Price", 0));
        label_quantity->setText(QApplication::translate("SearchAds", "Quantity", 0));
        label_category->setText(QApplication::translate("SearchAds", "Category", 0));
        label_seller->setText(QApplication::translate("SearchAds", "Seller", 0));
    } // retranslateUi
