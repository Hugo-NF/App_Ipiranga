...
public:
    ...
    void retranslateUi(QWidget *EditProfile)
    {
        ...
        TitleRegister->setText(QApplication::translate("EditProfile", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; text-decoration: underline; color:#087add;\">My Informations</span></p></body></html>", 0));
        Personal->setTitle(QApplication::translate("EditProfile", "   Personal Information ", 0));
        labelFirstName->setText(QApplication::translate("EditProfile", "First Name", 0));
        labelLastName->setText(QApplication::translate("EditProfile", "Last Name", 0));
        labelCPF->setText(QApplication::translate("EditProfile", "CPF", 0));
        labelRG->setText(QApplication::translate("EditProfile", "RG", 0));
        labelAge->setText(QApplication::translate("EditProfile", "Age", 0));
        labelPhone->setText(QApplication::translate("EditProfile", "Phone", 0));
        ...
        Private_1->setText(QApplication::translate("EditProfile", "<html><head/><body><p><span style=\" color:#a40000;\">*</span></p></body></html>", 0));
        Adress->setTitle(QApplication::translate("EditProfile", "   Address", 0));
        labelAdress->setText(QApplication::translate("EditProfile", "Address", 0));
        labelZIP->setText(QApplication::translate("EditProfile", "Zip Code", 0));
        labelState->setText(QApplication::translate("EditProfile", "State", 0));
        labelCity->setText(QApplication::translate("EditProfile", "City", 0));
        lineAdress->setText(QString());
        lineZIP->setText(QString());
        lineState->setText(QString());
        lineCity->setText(QString());
        Private_3->setText(QApplication::translate("EditProfile", "<html><head/><body><p><span style=\" color:#a40000;\">*</span></p></body></html>", 0));
        Payment->setTitle(QApplication::translate("EditProfile", "Payment", 0));
        labelExpiration->setText(QApplication::translate("EditProfile", "Expiration", 0));
        labelNumber->setText(QApplication::translate("EditProfile", "Number", 0));
        labelName->setText(QApplication::translate("EditProfile", "Name", 0));
        labelSecurity->setText(QApplication::translate("EditProfile", "N\302\272 Security", 0));
        lineNamePayment->setText(QString());
        lineNumber->setText(QString());
        lineSecurity->setText(QString());
        dateExpiration->setDisplayFormat(QApplication::translate("EditProfile", "yyyy/MMM", 0));
        radioButton_Credit->setText(QApplication::translate("EditProfile", "Credit", 0));
        radioButton_Debit->setText(QApplication::translate("EditProfile", "Debit", 0));
        Acess->setTitle(QApplication::translate("EditProfile", "   Access", 0));
        labelLogin->setText(QApplication::translate("EditProfile", "Login", 0));
        labelPass->setText(QApplication::translate("EditProfile", "Password", 0));
        labelEmail->setText(QApplication::translate("EditProfile", "E-mail", 0));
        lineLogin->setText(QString());
        linePass->setText(QString());
        labelConfirm->setText(QApplication::translate("EditProfile", "Confirm", 0));
        lineConfirm->setText(QString());
        lineEmail->setText(QString());
        Private_2->setText(QApplication::translate("EditProfile", "<html><head/><body><p><span style=\" color:#a40000;\">*</span></p></body></html>", 0));
        pushButton_Undo->setText(QApplication::translate("EditProfile", "Undo", 0));
        pushButton_Save->setText(QApplication::translate("EditProfile", "Save", 0));
        BankAccount->setTitle(QApplication::translate("EditProfile", "Bank Account", 0));
        labelName_2->setText(QApplication::translate("EditProfile", "Name", 0));
        labelBank->setText(QApplication::translate("EditProfile", "Bank", 0));
        labelAgency->setText(QApplication::translate("EditProfile", "Agency", 0));
        labelAccount->setText(QApplication::translate("EditProfile", "Account", 0));
        lineNameBank->setText(QString());
        lineAgency->setText(QString());
        lineAccount->setText(QString());
        comboBox_Bank->clear();
        comboBox_Bank->insertItems(0, QStringList()
         << QApplication::translate("EditProfile", "Banco do Brasil", 0)
         << QApplication::translate("EditProfile", "Bradesco", 0)
         << QApplication::translate("EditProfile", "Caixa Econ\303\264mica", 0)
         << QApplication::translate("EditProfile", "Ita\303\272", 0)
