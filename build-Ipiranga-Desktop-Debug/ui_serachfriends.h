...
public:
    ...
    void setupUi(QWidget *SerachFriends)
    {
        ...
        label_rating_2 = new QLabel(rating);
        label_rating_2->setObjectName(QStringLiteral("label_rating_2"));

        horizontalLayout_2->addWidget(label_rating_2);
    ...
    {
        SerachFriends->setWindowTitle(QApplication::translate("SerachFriends", "Form", 0));
        Friend_img->setText(QString());
        label_rating_2->setText(QApplication::translate("SerachFriends", "4.5", 0));
        label_2->setText(QApplication::translate("SerachFriends", "<html><head/><body><p>/<span style=\" font-size:8pt;\">5.0</span></p></body></html>", 0));
        label_city->setText(QApplication::translate("SerachFriends", "Cidade", 0));
        label_state->setText(QApplication::translate("SerachFriends", "Estado", 0));
        label_name->setText(QApplication::translate("SerachFriends", "Name", 0));
