...
#include "../Ipiranga_GUI/UserPages/friendspage.h"
...
const QMetaObject FriendsPage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FriendsPage.data,
      qt_meta_data_FriendsPage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FriendsPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FriendsPage.stringdata0))
        return static_cast<void*>(const_cast< FriendsPage*>(this));
