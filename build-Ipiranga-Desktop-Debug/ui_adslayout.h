...
public:
    ...
    {
        AdsLayout->setWindowTitle(QApplication::translate("AdsLayout", "Form", 0));
        Box_Ads->setTitle(QApplication::translate("AdsLayout", "Title of Ads", 0));
        label_price->setText(QApplication::translate("AdsLayout", "Price", 0));
        label_date->setText(QApplication::translate("AdsLayout", "Date", 0));
        label_quantity->setText(QApplication::translate("AdsLayout", "Quantity", 0));
        label_category->setText(QApplication::translate("AdsLayout", "Category", 0));
